...
export const createExerciseSchema = z.object({
  ...
  primaryMuscles: z.array(
    z.enum(Object.values(MUSCLE_GROUPS) as [MuscleGroupValue, ...MuscleGroupValue[]])
  ),
  instructions: z.array(z.string()),
  category: z.enum(Object.values(CATEGORY) as [CategoryValue, ...CategoryValue[]]),
  images: z.array(z.string()),
  id: z.string(), // Unique identifier
  force: z.enum(Object.values(FORCE) as [ForceValue, ...ForceValue[]]).optional(),
  mechanic: z.enum(Object.values(MECHANIC) as [MechanicValue, ...MechanicValue[]]).optional(),
  equipment: z.enum(Object.values(EQUIPMENT) as [EquipmentValue, ...EquipmentValue[]]).optional(),
  secondaryMuscles: z
